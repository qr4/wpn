...
int talk_set_user_code_reply_msg(unsigned int user_id, const char* msg, int msg_len); // send
...
// menupunkt 3
int talk_log_lua_msg(unsigned int user_id, const char* msg, int msg_len);  //send
