...
void json_output(cluster_t* planets, int n_planets) {
	...
	printf("      {\"id\":%d, \"x\": %f, \"y\": %f, \"owner\": null}\n", i, planets[n_planets].center.x, planets[n_planets-1].center.y);
	printf("    ],\n");
	printf("    \"ships\": [ ],\n");
	printf("    \"asteroids\": [ ],\n");
	printf("    \"players\": [\n");
